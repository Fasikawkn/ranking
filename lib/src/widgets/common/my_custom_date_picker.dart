...
import 'package:champs2022rank1ng/src/widgets/common/my_calender_picker.dart';
...
///
Future<DateTime?> showDateMyCustomePicker({
...
class _DatePickerDialogState extends State<DatePickerDialog>
  ...
  Size _dialogSize(BuildContext context) {
    ...
    // final size = Size(MediaQuery.of(context).size.width, MediaQuery.of(context).size.height * 0.5);
    switch (_entryMode.value) {
      case DatePickerEntryMode.calendar:
      case DatePickerEntryMode.calendarOnly:
        switch (orientation) {
  ...
  Widget build(BuildContext context) {
    ...
    MyCalendarDatePicker calendarDatePicker() {
