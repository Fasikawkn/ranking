...
class TopFavTeamFavNameOddImage extends StatefulWidget {
  const TopFavTeamFavNameOddImage(
      {Key? key,
      required this.team,
  ...
  @override
  State<TopFavTeamFavNameOddImage> createState() =>
      _TopFavTeamFavNameOddImageState();
}

class _TopFavTeamFavNameOddImageState extends State<TopFavTeamFavNameOddImage> {
              ...
              Row(
                ...
                children: [
                  IconButton(
                    ...
                    onPressed: () {
                      if (widget.caller == Caller.top) {
                        if (_isFavorite) {
                          favoriteContorller.deleteTeam(widget.team.flag);
                        } else {
                          favoriteContorller.insertTeam(widget.team);
                        }
                        _toggleFavorite();
                      } else {
                        widget.onPressed();
